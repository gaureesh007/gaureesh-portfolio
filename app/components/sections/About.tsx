...
export default function About() {
  ...
  useEffect(() => {
    ...
    // THE CORE — pin the section and scrub horizontal scroll
    gsap.to(container, {
      x: -totalWidth,
      ease: 'none',
      scrollTrigger: {
  ...
  return (
    <section
      ...
      style={{ height: '100vh' }}
    >
      {/* Horizontal container — holds all panels side by side */}
      <div
        ref={containerRef}
      ...
      >
        ...
        >
          <h2 style={{ fontFamily: 'Clash Display', fontSize: '4rem', color: '#f0f4ff' }}>
            Panel 1
          </h2>
        </div>
        ...
        <div
          className="flex items-center justify-center flex-shrink-0"
          style={{ width: '100vw', height: '100vh', backgroundColor: '#080d14' }}
        >
          <h2 style={{ fontFamily: 'Clash Display', fontSize: '4rem', color: '#2563eb' }}>
            Panel 2
          </h2>
        </div>
